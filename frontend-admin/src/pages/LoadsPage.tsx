              ...
              {loading ? (
                ...
                loads.map((load) => (
                  <tr key={load.id} className="border-b border-white/5 last:border-0">
                    ...
                    <td className="px-4 py-3 text-slate-300">{load.driverName}</td>
                    <td className="px-4 py-3 text-slate-300">{formatCurrency(load.rate)}</td>
                    <td className="px-4 py-3 text-slate-300">{load.miles}</td>
