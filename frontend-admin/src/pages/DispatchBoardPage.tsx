              ...
              {loading ? (
                ...
                loads.map((load) => (
                  <tr key={load.id} className="border-b border-surface-800 last:border-0">
                    <td className="px-4 py-3 font-mono text-xs font-semibold text-brand-400">
                      {load.loadNumber}
                    </td>
                    <td className="px-4 py-3 text-slate-300">
                      {load.driverName ?? 'Unassigned'}
                    </td>
                    <td className="px-4 py-3 font-medium text-white">{load.brokerName}</td>
                    <td className="px-4 py-3 text-slate-300">
                      <p>{load.pickupCity}</p>
                      <p className="text-xs text-slate-500">{formatDateOnly(load.pickupDate)}</p>
                    </td>
                    <td className="px-4 py-3 text-slate-300">
                      <p>{load.deliveryCity}</p>
                      <p className="text-xs text-slate-500">{formatDateOnly(load.deliveryDate)}</p>
                    </td>
